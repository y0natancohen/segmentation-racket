 ...
 * Adapted from video_send_recv for use in Phaser game.
 */

import type { IntensityMetrics, ConnectionStats, VideoConstraints, DataChannelConfig, VideoConfig, VideoConnection, VideoConnectionEvents } from './types';
