...
async def test_pipeline_fps(duration_seconds: int = 5):
    ...
    # Start the polygon generator directly
    print("🚀 Starting polygon generator...")
    
    # Start the polygon generator process
    process = subprocess.Popen(
        ["python3", "segmentation/polygon_generator.py", "segmentation/polygon_config/rectangle.json"],
