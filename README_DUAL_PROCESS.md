...
This project implements a dual-process architecture where the rectangle movement is generated by a separate Python process and communicated to the main TypeScript Phaser game via WebSocket.

## 🏗️ Architecture Overview

### **Process 1: Python Rectangle Generator**
- **File**: `rectangle_generator.py`
- **Purpose**: Generates rectangle movement data at 20 FPS
- **Communication**: WebSocket server on `localhost:8765`
- **Movement**: Sine wave up-down motion (2-second cycle)

### **Process 2: TypeScript Phaser Game**
- **File**: `phaser-matter-game/src/main.ts`
- **Purpose**: Handles ball physics, rendering, and game logic
- **Communication**: WebSocket client connecting to rectangle generator
- **Fallback**: Local rectangle movement if WebSocket unavailable
